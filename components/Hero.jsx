...
const Hero = () => {
  return (
    <div className="flex h-screen index oswald">
      <div className="m-auto">
        <h1 className="text-white font-size-1">
          So,
          <br />U made it here
          <br />
          huh?
      ...
      <div className="m-auto ml-10">
        ...
        <h1 className="font-size-2 text-white mb-2 py-6 ">MUSTAFA ISLAMOVIC</h1>
        <ul className="mb-24">
          <li className="py-2 text-[#8f39ff]">
            <Link href="/">Home</Link>
          </li>
          <li className="text-white py-2 hover:text-[#8f39ff]">
            <Link href="https://www.linkedin.com/in/mustafa-islamovic-874256235/">
              LinkedIn
            </Link>
          </li>
          <li className="text-white py-2 hover:text-[#8f39ff]">
